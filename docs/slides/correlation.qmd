...
<iframe src="https://wall.sli.do/event/hyvXkv8coCQhBxHhuMGD89" height="100%" width="100%" frameBorder="0" style="min-height: 560px;" title="Slido">
...
$$\Huge\mbox{r}_{xy}=\frac{\Sigma^n_{i=1}(x - \bar{x} )(y - \bar{y} )}{\Sigma^n_{i=1}(x_i- \bar{x})^2 \Sigma^n_{i=1}(y_i- \bar{y})^2}$$

## How is correlation calculated?


```{r out.width = "900px", out.height="800px", echo=F}
...
```{r echo=F, out.height= "700px", out.width="700px"}
